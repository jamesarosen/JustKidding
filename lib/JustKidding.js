(function($, window, undefined) {
  ...
  var calculateNewlySelected = function(justKidding, which) {
    var options = justKidding.options
      , current = justKidding.current()
      , up      = ((options.vim && which === j) || (options.wasd && which === s))
      , down    = ((options.vim && which === k) || (options.wasd && which === w));
  ...
  var bindEventHandler = function(justKidding) {
    $('body').bind('keypress.justKidding', function(e) {
      if (justKidding.options.actOnEvent(e)) {
  ...
  var JustKidding = function(container, options) {
    ...
    this.options = $.extend({}, JustKidding.defaultOptions, options || {});
    ...
    this.moveTo(initiallySelected(container, this.options.initialSelector));
